package com.jakartaee.mvc.config;
...
public class DataInitializer {
    ...
    void onStart(@Observes StartupEvent ev) {
        try {
            logger.info("Inicializando datos de ejemplo para MVC demo...");
            ...
            logger.info("Datos de ejemplo inicializados correctamente para MVC demo");
        } catch (Exception e) {
