...
public class VillainPanacheEntity extends PanacheEntity {
     ...
     */
    @ApplicationScoped
    public static class Repo implements PanacheRepository<VillainPanacheEntity> {
         ...
         */
        public List<VillainPanacheEntity> findDangerous() {
         ...
         */
        public List<VillainPanacheEntity> findByThreatLevel(String threatLevel) {
         ...
         */
        public List<VillainPanacheEntity> findPowerful(int minLevel) {
