package com.jakartaee.security.config;
...
public class DataInitializer {
    ...
    void onStart(@Observes StartupEvent ev) {
        try {
            logger.info("Inicializando datos de ejemplo para Security demo...");
            ...
            logger.info("Datos de ejemplo inicializados correctamente para Security demo");
            logger.info("Usuarios disponibles:");
            logger.info("  - superman/superman (roles: HERO, ADMIN)");
            logger.info("  - batman/batman (roles: HERO)");
            logger.info("  - joker/joker (roles: VILLAIN)");
            logger.info("  - lex/lex (roles: VILLAIN, ADMIN)");
        } catch (Exception e) {
