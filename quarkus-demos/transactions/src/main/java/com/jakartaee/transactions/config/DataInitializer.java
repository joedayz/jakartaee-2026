package com.jakartaee.transactions.config;
...
/**
 * Inicializador de datos para la demo de Transactions.
 * Crea héroes y villanos de ejemplo al iniciar la aplicación.
 * Demuestra el uso de @Transactional en la inicialización.
 */
@ApplicationScoped
public class DataInitializer {
    ...
    void onStart(@Observes StartupEvent ev) {
        try {
            logger.info("Inicializando datos de ejemplo para Transactions demo...");
            ...
            // Crear héroes usando transacciones
            ...
            logger.info("Datos de ejemplo inicializados correctamente para Transactions demo");
            logger.info("Creados 5 héroes y 4 villanos");
        } catch (Exception e) {
            logger.severe("Error al inicializar datos Transactions: " + e.getMessage());
            e.printStackTrace();
        }
    }
}
